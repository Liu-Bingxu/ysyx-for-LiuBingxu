...
assign return_addr_stack = core_debugger_top_with_bpu.u_core_top_with_bpu.u_frontend_top.u_bpu.u_ras.return_addr_stack;
assign return_addr_queue = core_debugger_top_with_bpu.u_core_top_with_bpu.u_frontend_top.u_bpu.u_ras.return_addr_queue;
...
generate for(entry_index = 0 ; entry_index < FTQ_ENTRY_NUM; entry_index = entry_index + 1) begin : U_gen_ftq_entry
    ftq_entry entry;
    assign entry = core_debugger_top_with_bpu.u_core_top_with_bpu.u_frontend_top.u_ftq.entry[entry_index];
...
generate for(ftb_entry_index = 0 ; ftb_entry_index < UFTB_ENTRY_NUM; ftb_entry_index = ftb_entry_index + 1) begin : U_gen_uftb_entry
    uftb_entry entry;
    assign entry = core_debugger_top_with_bpu.u_core_top_with_bpu.u_frontend_top.u_bpu.u_uftb.entry[ftb_entry_index];
...
DifftestArchIntRegState u_DifftestArchIntRegState(
    .io_value_0  	(64'h0                                  ),
    .io_value_1  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[1]    ),
    .io_value_2  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[2]    ),
    .io_value_3  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[3]    ),
    .io_value_4  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[4]    ),
    .io_value_5  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[5]    ),
    .io_value_6  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[6]    ),
    .io_value_7  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[7]    ),
    .io_value_8  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[8]    ),
    .io_value_9  	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[9]    ),
    .io_value_10 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[10]   ),
    .io_value_11 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[11]   ),
    .io_value_12 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[12]   ),
    .io_value_13 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[13]   ),
    .io_value_14 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[14]   ),
    .io_value_15 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[15]   ),
    .io_value_16 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[16]   ),
    .io_value_17 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[17]   ),
    .io_value_18 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[18]   ),
    .io_value_19 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[19]   ),
    .io_value_20 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[20]   ),
    .io_value_21 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[21]   ),
    .io_value_22 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[22]   ),
    .io_value_23 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[23]   ),
    .io_value_24 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[24]   ),
    .io_value_25 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[25]   ),
    .io_value_26 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[26]   ),
    .io_value_27 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[27]   ),
    .io_value_28 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[28]   ),
    .io_value_29 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[29]   ),
    .io_value_30 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[30]   ),
    .io_value_31 	(u_core_top_with_bpu.u_wbu.u_gpr.riscv_reg[31]   )
);

DifftestPerformRegState u_DifftestPerformRegState(
    .io_value_0  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[1]    ),
    .io_value_1  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[2]    ),
    .io_value_3  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[3]    ),
    .io_value_4  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[4]    ),
    .io_value_5  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[5]    ),
    .io_value_6  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[6]    ),
    .io_value_7  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[7]    ),
    .io_value_8  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[8]    ),
    .io_value_9  	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[9]    ),
    .io_value_10 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[10]   ),
    .io_value_11 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[11]   ),
    .io_value_12 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[12]   ),
    .io_value_13 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[13]   ),
    .io_value_14 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[14]   ),
    .io_value_15 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[15]   ),
    .io_value_16 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[16]   ),
    .io_value_17 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[17]   ),
    .io_value_18 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[18]   ),
    .io_value_19 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[19]   ),
    .io_value_20 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[20]   ),
    .io_value_21 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[21]   ),
    .io_value_22 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[22]   ),
    .io_value_23 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[23]   ),
    .io_value_24 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[24]   ),
    .io_value_25 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[25]   ),
    .io_value_26 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[26]   ),
    .io_value_27 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[27]   ),
    .io_value_28 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[28]   ),
    .io_value_29 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[29]   ),
    .io_value_30 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[30]   ),
    .io_value_31 	(u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[31]   )
);
warp u_warp();
DifftestCSRState u_DifftestCSRState(
    .io_privilegeMode 	({{62{1'b0}},u_core_top_with_bpu.u_wbu.u_csr.current_priv_status}),
    .io_mstatus       	(u_core_top_with_bpu.u_wbu.u_csr.mstatus                         ),
    .io_sstatus       	(u_core_top_with_bpu.u_wbu.u_csr.sstatus                         ),
    .io_mepc          	(u_core_top_with_bpu.u_wbu.u_csr.mepc                            ),
    .io_sepc          	(u_core_top_with_bpu.u_wbu.u_csr.sepc                            ),
    .io_mtval         	(u_core_top_with_bpu.u_wbu.u_csr.mtval                           ),
    .io_stval         	(u_core_top_with_bpu.u_wbu.u_csr.stval                           ),
    .io_mtvec         	(u_core_top_with_bpu.u_wbu.u_csr.mtvec                           ),
    .io_stvec         	(u_core_top_with_bpu.u_wbu.u_csr.stvec                           ),
    .io_mcause        	(u_core_top_with_bpu.u_wbu.u_csr.mcause                          ),
    .io_scause        	(u_core_top_with_bpu.u_wbu.u_csr.scause                          ),
    .io_satp          	(u_core_top_with_bpu.u_wbu.u_csr.satp                            ),
    .io_mip           	(u_core_top_with_bpu.u_wbu.u_csr.mip                             ),
    .io_mie           	(u_core_top_with_bpu.u_wbu.u_csr.mie                             ),
    .io_mscratch      	(u_core_top_with_bpu.u_wbu.u_csr.mscratch                        ),
    .io_sscratch      	(u_core_top_with_bpu.u_wbu.u_csr.sscratch                        ),
    .io_mideleg       	(u_core_top_with_bpu.u_wbu.u_csr.mideleg                         ),
    .io_medeleg       	(u_core_top_with_bpu.u_wbu.u_csr.medeleg                         )
);

reg  io_ls_flag_reg;
wire io_load_addr_flag;
wire io_store_addr_flag;
assign io_load_addr_flag  = ((u_core_top_with_bpu.dcache_araddr >= 64'h1000_0000) && (u_core_top_with_bpu.dcache_araddr < 64'h1000_0020)) | 
                            ((u_core_top_with_bpu.dcache_araddr >= 64'h1010_0000) && (u_core_top_with_bpu.dcache_araddr < 64'h1010_0030)) |
                            ((u_core_top_with_bpu.dcache_araddr >= 64'h0c00_0000) && (u_core_top_with_bpu.dcache_araddr < 64'h0c21_0000)) | 
                            ((u_core_top_with_bpu.dcache_araddr >= 64'ha000_0000) && (u_core_top_with_bpu.dcache_araddr < 64'ha000_0200)) | 
                            ((u_core_top_with_bpu.dcache_araddr >= 64'h0200_0000) && (u_core_top_with_bpu.dcache_araddr < 64'h0201_0000));
assign io_store_addr_flag = ((u_core_top_with_bpu.dcache_awaddr >= 64'h1000_0000) && (u_core_top_with_bpu.dcache_awaddr < 64'h1000_0020)) | 
                            ((u_core_top_with_bpu.dcache_awaddr >= 64'h1010_0000) && (u_core_top_with_bpu.dcache_awaddr < 64'h1010_0030)) | 
                            ((u_core_top_with_bpu.dcache_awaddr >= 64'h0c00_0000) && (u_core_top_with_bpu.dcache_awaddr < 64'h0c21_0000)) | 
                            ((u_core_top_with_bpu.dcache_awaddr >= 64'ha000_0000) && (u_core_top_with_bpu.dcache_awaddr < 64'ha000_0200)) | 
                            ((u_core_top_with_bpu.dcache_awaddr >= 64'h0200_0000) && (u_core_top_with_bpu.dcache_awaddr < 64'h0201_0000));
wire io_load_flag ;
wire io_store_flag;
assign io_load_flag  = u_core_top_with_bpu.dcache_arvalid & u_core_top_with_bpu.dcache_arready & io_load_addr_flag;
assign io_store_flag = u_core_top_with_bpu.dcache_awvalid & u_core_top_with_bpu.dcache_awready & io_store_addr_flag;
always @(posedge clock or negedge rst_n) begin
    ...
    else if(u_core_top_with_bpu.u_lsu.LS_EX_execute_ready)begin
        io_ls_flag_reg  <= 1'b0;
    end
end
wire skip_flag;
FF_D_without_asyn_rst #(1) u_skip_flag (clock,u_core_top_with_bpu.u_lsu.LS_EX_execute_ready,io_ls_flag_reg,skip_flag);

DifftestInstrCommit u_DifftestInstrCommit(
    .clock      	(clk                                                  ),
    .io_valid   	(u_core_top_with_bpu.u_wbu.LS_WB_reg_ls_valid    ),
    .io_skip    	(skip_flag                                            ),
    //todo 暂不支持查询是否压缩指令
    .io_isRVC   	(1'b0                                                 ),

    .io_rfwen   	(u_core_top_with_bpu.u_wbu.LS_WB_reg_dest_wen    ),
    .io_fpwen   	(1'b0                                                 ),
    .io_vecwen  	(1'b0                                                 ),
    .io_wpdest  	(u_core_top_with_bpu.u_wbu.LS_WB_reg_rd          ),
    .io_wdest   	({3'h0, u_core_top_with_bpu.u_wbu.LS_WB_reg_rd}  ),
    .io_pc      	((u_core_top_with_bpu.u_wbu.WB_IF_jump_flag) ? 
                    u_core_top_with_bpu.u_wbu.WB_IF_jump_addr : 
                    u_core_top_with_bpu.u_wbu.LS_WB_reg_next_PC     ),
    .io_instr   	(u_core_top_with_bpu.u_wbu.LS_WB_reg_inst        ),
    .io_robIdx  	(10'h0                                                ),
    .io_lqIdx   	(7'h0                                                 ),
    .io_sqIdx   	(7'h0                                                 ),
    //todo 暂不支持查询是否访存指令
...
DifftestTrapEvent u_DifftestTrapEvent(
    .clock         (clk                                                                    ),
    .enable        (u_core_top_with_bpu.u_wbu.u_csr.u_trap_control.trap_m_interrupt |
                    u_core_top_with_bpu.u_wbu.u_csr.u_trap_control.trap_s_interrupt          ),
    .io_hasTrap    (1'b0                                                                   ),
    .io_cycleCnt   (u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[1]            ),
    .io_instrCnt   (u_core_top_with_bpu.u_wbu.u_csr.Performance_Monitor[2]            ),
    .io_hasWFI     (1'b0                                                                   ),
    .io_code       (u_core_top_with_bpu.u_wbu.u_csr.u_trap_control.cause              ),
    .io_pc         (u_core_top_with_bpu.u_wbu.u_csr.u_trap_control.next_pc            ),
    .io_coreid     (8'h0                                                                   )
);


endmodule //core_debugger_top_with_bpu

module warp;
always begin
    // 中断
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[3] = 
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_exu.WB_EX_interrupt_flag;
    // load
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[4] = 
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.EX_LS_reg_execute_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[3]) & 
        (core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.EX_LS_reg_load_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.read_finish));
    // store
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[5] = 
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.EX_LS_reg_execute_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[3]) & 
        (core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.EX_LS_reg_store_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.write_finish));
    // atomic
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[6] = 
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.EX_LS_reg_execute_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[3]) & 
        (core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.EX_LS_reg_atomic_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_lsu.atomic_finish));
    // mul
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[7] = 
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_exu.ID_EX_reg_decode_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[3]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[4]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[5]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[6]) &
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_exu.ID_EX_reg_mul_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_exu.o_valid);
    // div
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[8] = 
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_exu.ID_EX_reg_decode_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[3]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[4]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[5]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[6]) &
        core_debugger_top_with_bpu.u_core_top_with_bpu.u_exu.ID_EX_reg_div_valid & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_exu.o_valid);
    // no inst
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[9] = 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_idu.IF_ID_reg_inst_valid) & 
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[3]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[4]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[5]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[6]) &
        (!core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[7]) &
    ...
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[12] = 
        (core_debugger_top_with_bpu.u_core_top_with_bpu.commit_restore & 
        core_debugger_top_with_bpu.u_core_top_with_bpu.ID_EX_reg_jump_valid);
    // jalr but commit restore time
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[13] = 
        (core_debugger_top_with_bpu.u_core_top_with_bpu.commit_restore & 
        core_debugger_top_with_bpu.u_core_top_with_bpu.ID_EX_reg_jump_valid & 
        core_debugger_top_with_bpu.u_core_top_with_bpu.ID_EX_reg_jump_jalr);
    // ret but commit restore time
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[14] = 
        (core_debugger_top_with_bpu.u_core_top_with_bpu.commit_restore & 
        core_debugger_top_with_bpu.u_core_top_with_bpu.ID_EX_reg_jump_valid & 
        core_debugger_top_with_bpu.u_core_top_with_bpu.jump_is_ret);
    // branch but commit restore time
    assign core_debugger_top_with_bpu.u_core_top_with_bpu.u_wbu.u_csr.MPerformance_Monitor_inc[15] = 
        (core_debugger_top_with_bpu.u_core_top_with_bpu.commit_restore & 
        core_debugger_top_with_bpu.u_core_top_with_bpu.ID_EX_reg_branch_valid);
end
endmodule
