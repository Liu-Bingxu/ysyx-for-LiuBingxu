...
//sram interface
logic [63:0]                icache_line_valid[0:ICACHE_GROUP-1][0:ICACHE_WAY-1];
logic [127:0]               sram_tag_rdata[0:ICACHE_TAG_GROUP-1][0:ICACHE_WAY-1];
logic [63:0]                sram_tag[0:ICACHE_GROUP-1][0:ICACHE_WAY-1];
logic                       sram_tag_cen[0:ICACHE_TAG_GROUP-1];
logic                       sram_tag_wen[0:ICACHE_TAG_GROUP-1][0:ICACHE_WAY-1];
logic [127:0]               sram_tag_bwen;
logic [127:0]               sram_data_rdata[0:ICACHE_GROUP-1][0:ICACHE_WAY-1];
logic                       sram_data_cen[0:ICACHE_GROUP-1];
logic                       sram_data_wen[0:ICACHE_GROUP-1][0:ICACHE_WAY-1];
logic [5:0]                 sram_addr;
logic [ICACHE_WAY_LEN-1:0]  rand_way;

//fifo signs 
logic [2:0]                 rch_fifo_cnt;
logic [2:0]                 mmu_fifo_cnt;
logic                       fifo_wen;
logic                       rch_fifo_ren;
logic                       mmu_fifo_ren;
logic [63:0]                fifo_wdata;
logic                       rch_fifo_empty;
logic [63:0]                rch_fifo_rdata;
logic                       mmu_fifo_empty;
logic [63:0]                mmu_fifo_rdata;
logic                       out_fifo_wen;
logic                       out_fifo_ren;
logic [65:0]                out_fifo_wdata;
logic                       out_fifo_empty;
logic [65:0]                out_fifo_rdata;
logic [2:0]                 out_fifo_cnt;
...
logic [2:0]                 icache_fsm;
logic [1:0]                 icache_ifu_resp_reg;
logic                       icache_arvalid_reg;
...
logic [127:0]               sram_data_way_reg[0:ICACHE_WAY-1];
logic [63:0]                sram_tag_way_reg[0:ICACHE_WAY-1];
logic [63:0]                icache_line_valid_way_reg[0:ICACHE_WAY-1];
...
logic                       way_flag_nxt;
logic                       way_flag;
logic [127:0]               sram_data_way_use[0:ICACHE_WAY-1];
logic [63:0]                sram_tag_way_use[0:ICACHE_WAY-1];
logic [63:0]                icache_line_valid_way_use[0:ICACHE_WAY-1];

logic [127:0]               sram_data_way[0:ICACHE_WAY-1];
logic [63:0]                sram_tag_way[0:ICACHE_WAY-1];
logic [63:0]                icache_line_valid_way[0:ICACHE_WAY-1];

logic [ICACHE_WAY-1:0]      sram_way_sel;
logic [127:0]               sram_data_sel;
//**********************************************************************************************
//?icache sram
