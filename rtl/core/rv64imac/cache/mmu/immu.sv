...
//sram interface
logic [31:0]             tlb_4K_valid;
logic [127:0]            tlb_4K[0:31];
logic [31:0]             tlb_4K_wen;
logic [7:0]              tlb_sp_valid;
logic [127:0]            tlb_sp[0:7];
logic [7:0]              tlb_sp_wen;
logic [47:0]             tlb_hit;
...
endgenerate
assign stage_jump_mmu       =   (current_priv_status == M_LEVEL) | (satp_mode == 4'h0);
...
assign paddr_error_out  =   ((vaddr[63:39] != {25{vaddr[38]}}) | 
                            ...
                            ((stage_status == SEND_ADDR) & pte_error)) & (!stage_jump_mmu);
