...
(
    ...
    output                                              mul_valid_o,
    input                                               mul_ready_o,
    output rob_entry_ptr_t                              mul_rob_ptr_o,
    output pint_regdest_t                               mul_pwdest_o,
    output [63:0]                                       mul_preg_wdata_o
);

logic [1:0] mul_signed;

logic       pipeline1_valid;
logic       pipeline1_ready;
logic       pipeline2_valid;
logic       pipeline2_ready;
...
logic[64:0] mul_a_sign;
logic[64:0] mul_b_sign;

logic[65:0] booth_code0,  booth_code1,  booth_code2,  booth_code3,  booth_code4,  booth_code5;
logic[65:0] booth_code6,  booth_code7,  booth_code8,  booth_code9,  booth_code10, booth_code11;
logic[65:0] booth_code12, booth_code13, booth_code14, booth_code15, booth_code16, booth_code17;
logic[65:0] booth_code18, booth_code19, booth_code20, booth_code21, booth_code22, booth_code23;
logic[65:0] booth_code24, booth_code25, booth_code26, booth_code27, booth_code28, booth_code29;
logic[65:0] booth_code30, booth_code31, booth_code32;

logic[1:0] h0,  h1,  h2,  h3,  h4,  h5;
logic[1:0] h6,  h7,  h8,  h9,  h10, h11;
logic[1:0] h12, h13, h14, h15, h16, h17;
logic[1:0] h18, h19, h20, h21, h22, h23;
logic[1:0] h24, h25, h26, h27, h28, h29;
logic[1:0] h30, h31, h32;

logic sign0,  sign1,  sign2,  sign3,  sign4,  sign5;
logic sign6,  sign7,  sign8,  sign9,  sign10, sign11;
logic sign12, sign13, sign14, sign15, sign16, sign17;
logic sign18, sign19, sign20, sign21, sign22, sign23;
logic sign24, sign25, sign26, sign27, sign28, sign29;
logic sign30, sign31, sign32;
...
/* verilator lint_off UNUSEDSIGNAL */
logic[71:0] l1_0,  l1_1,  l1_2,  l1_3;
logic[73:0] l1_4,  l1_5;
logic[73:0] l1_6,  l1_7,  l1_8,  l1_9,  l1_10, l1_11;
logic[73:0] l1_12, l1_13, l1_14, l1_15, l1_16, l1_17;
logic[73:0] l1_18, l1_19, l1_20, l1_21, l1_22, l1_23;
logic[73:0] l1_24, l1_25, l1_26, l1_27, l1_28, l1_29;
logic[73:0] l1_30, l1_31;
logic[65:0] l1_32, l1_33;

logic[71:0] sum1_0;
logic[73:0] sum1_1,  sum1_2,  sum1_3,  sum1_4,  sum1_5, sum1_6,  sum1_7;

logic[72:0] carry1_0;
logic[74:0] carry1_1,  carry1_2,  carry1_3,  carry1_4,  carry1_5, carry1_6,  carry1_7;
/* verilator lint_on UNUSEDSIGNAL */
...
/* verilator lint_off UNUSEDSIGNAL */
logic[81:0] l2_0,  l2_1,  l2_2;
logic[83:0] l2_3,  l2_4,  l2_5;
logic[83:0] l2_6,  l2_7,  l2_8,  l2_9,  l2_10, l2_11;
logic[81:0] l2_12, l2_13, l2_14;
logic[73:0] l2_15, l2_16, l2_17;

logic[81:0] sum2_0;
logic[83:0] sum2_1,  sum2_2,  sum2_3;
logic[81:0] sum2_4;
logic[73:0] sum2_5;

logic[82:0] carry2_0;
logic[84:0] carry2_1,  carry2_2,  carry2_3;
logic[82:0] carry2_4;
logic[74:0] carry2_5;
/* verilator lint_on UNUSEDSIGNAL */
...
logic[83:0] sum2_2_reg;
logic[83:0] sum2_3_reg;
logic[81:0] sum2_4_reg;
logic[73:0] sum2_5_reg;

logic[82:0] carry2_0_reg;
logic[84:0] carry2_1_reg;
logic[84:0] carry2_2_reg;
logic[84:0] carry2_3_reg;
logic[81:0] carry2_4_reg;
...
assign mul_ready_i = ((!pipeline1_valid) | pipeline1_ready);

//? L3 compressor42 12 -> 6
/* verilator lint_off UNUSEDSIGNAL */
logic[90:0] l3_0,  l3_1,  l3_2, l3_3;
logic[92:0] l3_4,  l3_5, l3_6,  l3_7;
logic[81:0] l3_8,  l3_9,  l3_10, l3_11;
...
//? L4 compressor32 6 -> 4
/* verilator lint_off UNUSEDSIGNAL */
logic[114:0] l4_0,  l4_1,  l4_2;
logic[105:0] l4_3,  l4_4,  l4_5;

logic[114:0] sum4_0;
logic[105:0] sum4_1;

logic[115:0] carry4_0;
logic[106:0] carry4_1;
/* verilator lint_on UNUSEDSIGNAL */
...
//? L5 compressor42 4 -> 2
/* verilator lint_off UNUSEDSIGNAL */
logic[127:0] l5_0,  l5_1, l5_2,  l5_3;

logic[127:0] sum5_0;

logic[128:0] carry5_0;
/* verilator lint_on UNUSEDSIGNAL */
