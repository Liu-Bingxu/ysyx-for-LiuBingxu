...
generate for(rat_decode_index = 0 ; rat_decode_index < decode_width; rat_decode_index = rat_decode_index + 1) begin : U_gen_rat_decode
    ...
    u_int_src1_fromrat(
        .clk      	( clk                                       ),
        .wen      	( src1_wen                                  ),
        .data_in  	( int_rat[int_src1_torat[rat_decode_index]] ),
    ...
    u_int_src2_fromrat( 
        .clk      	( clk                                       ),
        .wen      	( src2_wen                                  ),
        .data_in  	( int_rat[int_src2_torat[rat_decode_index]] ),
    ...
    u_int_dest_fromrat(
        .clk      	( clk                                       ),
        .wen      	( dest_wen                                  ),
        .data_in  	( int_rat[int_dest_torat[rat_decode_index]] ),
...
generate for(rat_index = 1 ; rat_index < 32; rat_index = rat_index + 1) begin : U_gen_rat
    ...
    always_comb begin : rename_commit
        ...
        int_rat_wen = ((int_temp_rat_wen & rename_fire) | redirect);
        int_rat_nxt =   ({int_preg_width{redirect & int_arch_rat_wen   }} & int_arch_rat_nxt       ) | 
