// the top design module for cpu core with i/d cache and bpu
...
assign jump_restore_flag = EX_IF_jump_flag; // restore flag
assign jump_push_addr = ID_EX_reg_next_PC;  // restore push addr
...
// wire flush_i_flag_set;
// wire flush_i_flag_clr;
// wire flush_i_flag_wen;
// wire flush_i_flag_nxt;
// assign flush_i_flag_set = flush_i_valid & (!flush_i_flag);
// assign flush_i_flag_clr = flush_i_valid & flush_i_ready;
// assign flush_i_flag_wen = (flush_i_flag_set | flush_i_flag_clr);
// assign flush_i_flag_nxt = (flush_i_flag_set | (!flush_i_flag_clr));
// FF_D_with_wen #(
//     .DATA_LEN 	(1  ),
//     .RST_DATA 	(0  ))
// u_flush_i_flag(
...
assign jump_flag         = (WB_IF_jump_flag | WB_IF_satp_change | WB_IF_reg_sflush_valid | (flush_i_valid & flush_i_ready));
assign jump_addr         = (WB_IF_jump_flag) ? WB_IF_jump_addr : 
                                (flush_i_valid & flush_i_ready) ? EX_LS_reg_next_PC : 
...
assign d_mmu_flush_valid = LS_EX_flush_flag | (flush_i_valid & flush_i_ready);
